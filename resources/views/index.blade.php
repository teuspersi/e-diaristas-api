        ...
        <tbody>
            @forelse ($diaristas as $diarista)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('diaristas.edit', $diarista) }}" class="btn btn-primary btn-sm">Editar</a>
                        <a href="{{ route('diaristas.destroy', $diarista) }}" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja apagar?')">Excluir</a>
                    </td>
                </tr>
            @empty 
                <tr>
